...
lrc = joblib.load(os.path.join(STORAGE_DIR, 'voting_classifier.pkl'))
...
le = LabelEncoder()
le.classes_ = np.load(os.path.join(STORAGE_DIR, 'labelencoder_classes_votingclassifier.npy'), allow_pickle=True)
